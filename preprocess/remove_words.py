...
for doc_content in doc_content_list:
    ...
    doc_words = []
    for word in words:
        # word not in stop_words and word_freq[word] >= 5 and Words consist of pure numbers
        if dataset == 'mr' and word.isdigit()==False:
            doc_words.append(word)
        elif word not in stop_words and word_freq[word] >= 5 and word.isdigit()==False:
            doc_words.append(word)
